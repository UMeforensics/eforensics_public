...
county_registered_voters <- read.table("./test/VoterCount.txt", header = FALSE, dec = "."); 
...
samples = eforensics(w ~ N, a ~ N, data=michigan_county_all, model='bl', mcmc=mcmc, eligible.voters="N");
summary(samples); 
